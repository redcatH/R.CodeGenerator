...
public static class TypeHelper
{
    ...
    public static TProperty? ChangeTypePrimitiveExtended<TProperty>(object? value)
    {
        ...
        throw new Exception("ChangeTypePrimitiveExtended<TProperty> does not support non-primitive types. Use non-generic GetProperty method and handle type casting manually.");
    }
